...
const call=()=>POST(createMockRequest('/api/import/sie/import-1/replace',{method:'POST'}),createMockRouteParams({id:'import-1'}))
describe('SIE replace compatibility endpoint',()=>{
